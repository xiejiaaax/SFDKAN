...
class fusion_loss_med(nn.Module):
    ...
    def forward(self, image_A, image_B, image_fused):
        ...
        # fusion_loss_A = loss_l1 + 3*loss_gradient + 5*loss_SSIM
        # fusion_loss_B = loss_l1 + 3*loss_gradient + 7*loss_SSIM
        # fusion_loss_C = loss_l1 + 5*loss_gradient + 7*loss_SSIM
        # fusion_loss_D = 3*loss_l1 + loss_gradient + 5*loss_SSIM
        # fusion_loss_E = 3*loss_l1 + loss_gradient + 7*loss_SSIM
        # fusion_loss_F = 5*loss_l1 + loss_gradient + 7*loss_SSIM
        # fusion_loss_G = 3*loss_l1 + 5*loss_gradient + loss_SSIM
        # fusion_loss_H = 3*loss_l1 + 7*loss_gradient + loss_SSIM
        # fusion_loss_I = 5*loss_l1 + 7*loss_gradient + loss_SSIM
